...
public:
   ...
   * \sa readBEDFile()
   */
  void parseSNP(int nrf, int rest, unsigned char * memBlock, double *genotypes, double *missings, SNP* snp);
   ...
   */
  void parseSNPbyte(unsigned char g, int n, int d, double * genotypes, double * missings, SNP* snp);
   ...
   */
  void printGenotype(bool showGroups = false);
};
