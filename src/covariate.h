...
public:
  ...
  Covariate(std::string fcov, std::string fqcov, std::vector<std::string> emptyIndividualIds, bool constructMatrix = true);
  ~Covariate();
   ...
   */
  void readRawCovariate(std::string f, std::vector< std::vector<std::string> > & covars);
