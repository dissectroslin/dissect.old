...
std::string Range::explainRange(int x)
{
  ...
  {
    ss << x << " must be >= " << this->iDownThreshold;
    return ss.str();
  }
  else if( (this->downThresholdActive == false) && (this->upThresholdActive == true) )
  {
    ss << x << " must be <= " << this->iUpThreshold;
    return ss.str();
  }
  else
  {
    ss << x << " must be >= " << this->iDownThreshold << " and <= " << this->iUpThreshold;
    return ss.str();
  }
  return ""; 
}
...
std::string Range::explainRange(double x)
{
  ...
  {
    ss << x << " must be >= " << this->dDownThreshold;
    return ss.str();
  }
  else if( (this->downThresholdActive == false) && (this->upThresholdActive == true) )
  {
    ss << x << " must be <= " << this->dUpThreshold;
    return ss.str();
  }
  else
  {
    ss << x << " must be >= " << this->dDownThreshold << " and <= " << this->dUpThreshold;
    return ss.str();
  }
  return ""; 
}
