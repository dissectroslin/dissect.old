...
public:
   ...
   */
  Kernel(std::string f, KernelType readType = kernelGRM, int useColumn = 0);
   ...
   */
  void createKernelFromDiscreteCovariates(std::string fn, int useColumn);
   ...
   * this = scalingFactor2*this + scalingFactor1*kernel1. randomVarNames bahaviour strongly depends on Kernel type. Resultant Kernel name is the joined names of grm1
   * and grm2.
   * 
